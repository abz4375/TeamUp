...
function ManageProject(props: any) {
  ...
  return (
    <div>
      ...
      >
        <Fade in={open}>
          <ModalContent sx={style} className=" w-4/5 h-4/5">
            <div
              id="transition-modal-title"
              className="modal-title text-left text-3xl font-extralight transition h-fit border-none border-red-500 pt-0 flex flex-row"
            >
            ...
            <div
              className={
                currentPage === "info"
                  ? "transition-all border-2 border-blue-900 border-opacity-10 w-full mx-auto mt-0 overflow-auto modal-content h-full rounded-lg p-1 bg-blue-50 "
                  : "transition-all border-t-2 border-gray-500 w-full mt-0 overflow-hidden modal-content h-0 p-4"
              }
              //   style={{height:'75vh'}}
            >
              <div
              ...
              >
                <div className=" w-2/3 border-2 border-blue-900 border-opacity-10 rounded-md m-1 bg-white p-4 text-lg flex flex-col shadow-md h-full my-auto">
                  <Markdown
                    // className={' pt-2' + (toShowMarkdownPreview)?'':' hidden'}
                    className=" text-lg border-none border-red-500 "
                  ...
                  />
                  {/* <div className="border-none border-black h-8 mb-0 mt-auto flex flex-row">
                    <button className=" w-fit ml-auto mr-0 text-sm p-1 px-2 border-2 border-blue-500">
                      Edit
                    </button>
                  </div> */}
                </div>
                <div className=" w-1/3 border-2 border-gray-600 rounded-md m-1 bg-gray-50 flex flex-col overflow-hidden border-opacity-15 shadow-md">
                  <span className="mt-0 w-full px-4 py-2 font-light text-2xl h-fit bg-gray-200 border-b-2 border-gray-400">
                    Contributors
                  </span>
                  <div className="flex flex-col overflow-auto">
                    {/* <div className="w-full p-2 text-md bg-blue-50 border-b-2 border-gray-200">
                      Member
                    </div> */}
                    {info?.contributors.map((contributor) => (
                      <div className=" p-2 text-lg font-light bg-white border-2 border-gray-200 mx-1 mt-1 rounded-md shadow-sm flex flex-row ">
                        <Avatar src={''} className="my-auto mr-2"/>
                        <span className="my-auto">{contributor}</span>
                      </div>
                    ))}
                  </div>
                </div>
